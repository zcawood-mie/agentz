...
- Default database comes from the `project-registry` skill's index (read `$AGENTS_ROOT/memories/project-index.md` for the "Default local database" value) — other databases are only used when the user explicitly specifies them
